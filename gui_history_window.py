...
class SalesHistoryWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.rowconfigure(2, weight=0) # Default summary row
        self.rowconfigure(3, weight=0) # Custom date entry row
        self.rowconfigure(4, weight=1) # Custom summary tree row
        self.rowconfigure(5, weight=0) # Custom total row
        self.rowconfigure(6, weight=0) # Buttons row
        ...
        sales_columns_display = ("sale_num", "receipt_no", "timestamp", "customer", "total")
        ...
        # Custom Date Range Details Treeview
        ...
        self.custom_range_grand_total_label = ttk.Label(self, text=f"Selected Range Total: {gui_utils.CURRENCY_SYMBOL}0.00", font=("Arial", 10, "bold"))
    ...
    def populate_sales_list(self):
        ...
        # Fetch oldest first to calculate correct receipt number
        ...
        if sales_data:
            ...
            for sale in sales_data:
                ...
                self.sales_tree.insert("", 0, values=(sale_id, receipt_counter, display_ts, customer_name, total_display), iid=sale_id)
        else:
            pass
        self.update_receipt_display("") # Clear receipt when list reloads
